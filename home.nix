...
in
{
  ...
  home.packages = with pkgs; [
    # dotfiles: chezmoi applies my-configs/home-chezmoi; home-manager keeps only
    # desktop-session files and packages
    chezmoi
    # shell; atuin/zoxide/delta/eza and friends come from mise
    mise
    nushell
    starship
    direnv
