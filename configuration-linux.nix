...

{
  ...
  # CVE-2026-31431 (Copy Fail) and CVE-2026-46300 (Fragnesia, CVSS 7.8, XFRM ESP-in-TCP
  # priv-esc via skb_try_coalesce) both require kernel 6.18.22+ to be fixed. Confirmed via
  # `nix eval .#nixosConfigurations.nixos_linux.config.boot.kernelPackages.kernel.version`
  # -> 6.18.36 on 2026-06-27. Both fixes are present; the algif_aead blacklist below is kept
  # as defense-in-depth (removing a standing mitigation is a deliberate human call, not an
  # automated one).
