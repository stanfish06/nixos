...

{
  ...
  #   CONFIRMED FIXED 2026-06-25: `nix eval .#nixosConfigurations.nixos_linux.config.boot.kernelPackages.kernel.version`
  #   reports 6.18.36 (>= 6.18.22), so the algif_aead blacklist below is no longer required for
  #   this CVE. Left in place as defense-in-depth.
  ...
  #   esp4/esp6 kept for VPN. CONFIRMED FIXED 2026-06-25: kernel 6.18.36 (>= 6.18.22 patch
