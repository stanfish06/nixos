...

{
  ...
  # CVE-2026-43284 / CVE-2026-43500 (Dirty Frag): affects esp4/esp6 (IPsec ESP) and rxrpc (AFS).
  # rxrpc disabled here; esp4/esp6 kept enabled because this machine uses an IPsec VPN.
