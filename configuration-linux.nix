...

{
  ...
  #   Confirmed via `nix eval .#nixosConfigurations.nixos_linux.config.boot.kernelPackages.kernel.version`
  #   on 2026-06-22: kernel is 6.18.35, well past 6.18.22+ and the 2026-05-13 patch date.
